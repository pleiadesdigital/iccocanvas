		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('pleiadesmoon-panel '); ?> >
			...
			<section id="project" class="fpsection">
			  <div class="fpwrap project-wrap">
			    ...
			    <p>Nihil enim iam habes, quod ad corpus referas; Sed quid minus probandum quam esse aliquem beatum nec satis beatum? Egone quaeris, inquit, quid sentiam? Tibi hoc incredibile, quod beatissimum. Terram, mihi crede, ea lanx et maria deprimet. Negat enim summo bono afferre incrementum diem. Nam adhuc, meo fortasse vitio, quid ego quaeram non perspicis. An est aliquid, quod te sua sponte delectet?</p>
